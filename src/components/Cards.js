...
import { Modal, Button, Spacer, Card, Row, Text, Link } from "@nextui-org/react";
...
function Switches({ title, coverImage, type, config, manu, price, status, keygem, candykeys, novelkeys }) {
